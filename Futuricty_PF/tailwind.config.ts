	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				mobility: {
					DEFAULT: 'hsl(var(--mobility))',
					foreground: 'hsl(var(--mobility-foreground))'
				},
				affordability: {
					DEFAULT: 'hsl(var(--affordability))',
					foreground: 'hsl(var(--affordability-foreground))'
				},
				accessibility: {
				...
				religious: {
					DEFAULT: 'hsl(var(--religious))',
					foreground: 'hsl(var(--religious-foreground))'
				},
				sidebar: {
